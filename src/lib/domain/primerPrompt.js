...
export const SYSTEM = [
  ...
  "- Keep it tight. The big idea is two or three sentences; a takeaway is a",
  "  sentence, not a paragraph. Four or five takeaways.",
  "- Every takeaway on ONE line, however long. Do not wrap them.",
